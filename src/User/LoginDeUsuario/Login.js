...
function LoginComponente(){
  ...
  const navigate = useNavigate();
    ...
    //Persona
    const [persona, setPersona] = useState({nombre:'', password:'', documento:'', mail:''});
            ...
            <div className='contenedor-datos'>
              <h1 className='bienvenido'>¡Bienvenido/a!</h1>
                <form>
                  ...
                  <input className='globo' type="text" placeholder="Mail" name="mail" id='mail' value={persona.mail} onChange={manejarCambioEntrada} required/>
